...
namespace GameClient.Converters
{
    ...
    //        Uri picture = null;
    //        GameCode.Models.GameObject.GameObjectType gen = (GameCode.Models.GameObject.GameObjectType)values[0];
    //        GameCode.Models.BotClass gen2 = (GameCode.Models.BotClass)values[1];
    //        if (gen == GameCode.Models.GameObject.GameObjectType.Bot)
    //        {
    ...
    //            }
    //        }
    //        else if (gen == GameCode.Models.GameObject.GameObjectType.Player)
    //        {
