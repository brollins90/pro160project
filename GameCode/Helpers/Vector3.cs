...
namespace GameCode.Helpers
{
    public struct Vector3
    {
        ...
        public Vector3(double X = 0.0, double Y = 0.0, double Z = 0.0) : this()
        {
            x = X;
            y = Y;
            z = Z;
        ...
        //public static float CrossProduct(this Vector3 lhs, Vector3 rhs) { return ((lhs.x * rhs.y) - (lhs.y * rhs.x)); }
